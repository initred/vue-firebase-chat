...
import DocumentationIcon from "@/assets/icon-documentation.svg?component"
import ToolingIcon from "@/assets/icon-tooling.svg?component"
import EcosystemIcon from "@/assets/icon-ecosystem.svg?component"
import CommunityIcon from "@/assets/icon-community.svg?component"
import SupportIcon from "@/assets/icon-support.svg?component"
</script>
